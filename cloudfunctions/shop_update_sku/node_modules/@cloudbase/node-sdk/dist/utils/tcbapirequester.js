...
exports.TcbApiHttpRequester = void 0;
...
const metadata_secret_1 = require("./metadata-secret");
...
async function getCredentialsOnDemand(credentials) {
    ...
    if (!secretId || !secretKey) {
        ...
        if ((0, cloudplatform_1.checkIsInCBR)()) {
            const tmpSecret = await (0, metadata_secret_1.getTmpSecret)();
            newCredentials = {
        ...
        if (await (0, cloudplatform_1.checkIsInTencentCloud)()) {
            const tmpSecret = await (0, metadata_secret_1.getTmpSecret)();
            newCredentials = {
                secretId: tmpSecret.id,
                secretKey: tmpSecret.key,
...
class TcbApiHttpRequester {
    constructor(args) {
        ...
        this.tracingInfo = (0, tracing_1.generateTracingInfo)();
    ...
    getHeaders(method, url, params) {
        ...
        const SOURCE = `${TCB_SOURCE || ''},${args.opts.runEnvTag}`;
